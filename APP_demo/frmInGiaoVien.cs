...
namespace APP_demo
{
	public partial class frmInGiaoVien : Form
	{
		string strCon = "Data Source=LAPTOP-HK1PT9J5;Initial Catalog=quanlykhoahoc;Integrated Security=True";
		SqlConnection sqlCon = null;
		public frmInGiaoVien()
		{
			InitializeComponent();
		}

		private void frmInGiaoVien_Load(object sender, EventArgs e)
		{
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "APP_demo.ReportGiaoVien.rdlc";

			// Tạo ReportDataSource và gán dữ liệu từ DataSet
			ReportDataSource rds = new ReportDataSource();
			rds.Name = "DataSetGiaoVien";
			rds.Value = ds.Tables["GIAOVIEN"];
