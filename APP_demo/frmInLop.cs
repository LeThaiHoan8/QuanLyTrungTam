...
//khai báo thư viên dùng để tạo report in ấn
/*using System.Data.SqlClient;
using Microsoft.Reporting.WinForms;*/
...
namespace APP_demo
{
	public partial class frmInlop : Form
	{
		...
		private void frmInlop_Load(object sender, EventArgs e)
		{
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "APP_demo.ReportLop.rdlc";

			// Tạo ReportDataSource và gán dữ liệu từ DataSet
			ReportDataSource rds = new ReportDataSource();
			rds.Name = "datasetLop";
			rds.Value = ds.Tables["LOP"];
